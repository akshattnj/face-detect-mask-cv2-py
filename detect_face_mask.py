...
not_mask_font_color = (0, 0, 255)
thickness = 2
font_scale = 1
mask = "Thank You for wearing MASK"
not_mask = "Please wear MASK to defeat Corona"
    ...
    if(len(faces) == 0 and len(faces_bw) == 0):
        ...
        if(len(mouth_rects) == 0):
            ...
            for (mx, my, mw, mh) in mouth_rects:
                ...
                if(y < my < y + h):
                    #lips=1 => not wearing mask
                    cv2.putText(img, not_mask, org, font, font_scale, not_mask_font_color, thickness, cv2.LINE_AA)
